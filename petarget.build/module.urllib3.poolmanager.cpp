...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "urllib3.poolmanager", 233);
...
void checkModuleConstants_urllib3$poolmanager(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "urllib3.poolmanager", 233);
}
#endif
...
static PyObject *impl_urllib3$poolmanager$$$function__14_urlopen(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_2:;
    {
        ...
        {
            PyObject *dir_call_args[] = {tmp_dircall_arg1_1, tmp_dircall_arg2_1, tmp_dircall_arg3_1};
            tmp_assign_source_3 = impl___main__$$$function__18_complex_call_helper_pos_star_dict(dir_call_args);
        }
        if (tmp_assign_source_3 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    branch_no_2:;
    {
...

        {
            ...
            tmp_assign_source_4 = impl___main__$$$function__18_complex_call_helper_pos_star_dict(dir_call_args);
        }
        if (tmp_assign_source_4 == NULL) {
            assert(ERROR_OCCURRED());
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        UPDATE_STRING_DICT1(moduledict_urllib3$poolmanager, (Nuitka_StringObject *)mod_consts[136], tmp_assign_source_4);
    }
    {
        PyObject *tmp_assign_source_5;
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_12)) {
            ...
            tmp_assign_source_20 = IMPORT_NAME(tmp_import_name_from_12, mod_consts[84]);
        }
