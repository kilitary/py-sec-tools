...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "pywin.dialogs.list", 137);
...
void checkModuleConstants_pywin$dialogs$list(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "pywin.dialogs.list", 137);
}
#endif
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "pywin.dialogs.list";
...
PyObject *modulecode_pywin$dialogs$list(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("pywin.dialogs.list: Skipping module init, already done.\n");
#endif
