...
static PyObject *impl_urllib3$contrib$pyopenssl$$$function__9_recv(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_assign_source_2 = impl___main__$$$function__17_complex_call_helper_star_list_star_dict(dir_call_args);
        }
        if (tmp_assign_source_2 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    branch_no_6:;
    {
...

        {
            ...
            tmp_return_value = impl___main__$$$function__17_complex_call_helper_star_list_star_dict(dir_call_args);
        }
        if (tmp_return_value == NULL) {
            assert(ERROR_OCCURRED());
