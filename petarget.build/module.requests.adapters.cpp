...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "requests.adapters", 279);
...
void checkModuleConstants_requests$adapters(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "requests.adapters", 279);
}
#endif
...
static PyObject *impl_requests$adapters$$$function__9_proxy_manager_for(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Tried code:
    {
...

        {
            ...
            tmp_assign_source_7 = impl___main__$$$function__19_complex_call_helper_pos_keywords_star_dict(dir_call_args);
        }
