...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "pywin.dialogs.status", 185);
...
void checkModuleConstants_pywin$dialogs$status(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "pywin.dialogs.status", 185);
}
#endif
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "pywin.dialogs.status";
...
PyObject *modulecode_pywin$dialogs$status(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("pywin.dialogs.status: Skipping module init, already done.\n");
#endif
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_26 = impl___main__$$$function__12__mro_entries_conversion(dir_call_args);
        }
