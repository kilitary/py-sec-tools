...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "win32com.client.makepy", 218);
...
void checkModuleConstants_win32com$client$makepy(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "win32com.client.makepy", 218);
}
#endif
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "win32com.client.makepy";
...
PyObject *modulecode_win32com$client$makepy(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("win32com.client.makepy: Skipping module init, already done.\n");
#endif
