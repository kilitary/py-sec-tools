...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "commctrl", 1741);
...
void checkModuleConstants_commctrl(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "commctrl", 1741);
}
#endif
...
NUITKA_MAY_BE_UNUSED static char const *module_full_name = "commctrl";
...
PyObject *modulecode_commctrl(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *module_entry) {
    ...
    if (_init_done) {
#ifdef _NUITKA_TRACE
        PRINT_STRING("commctrl: Skipping module init, already done.\n");
#endif
