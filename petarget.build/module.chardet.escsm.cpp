...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "chardet.escsm", 57);
...
void checkModuleConstants_chardet$escsm(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "chardet.escsm", 57);
}
#endif
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_79edd207307bf2bc338f79e96f51b0cd = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[56], NULL, NULL, 0, 0, 0);
}
