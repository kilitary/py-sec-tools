...
max). e.g. if this bit is set, __int128 has 16-byte alignment. this
bit is not used by ida yet
"""
...
def getinf_str(*args):
    ...
    getinf_str(tag) -> str
        @param tag: one of inftag_t constants (C++: inftag_t)
...
def switch_dbctx(*args):
    ...
    switch_dbctx(idx) -> dbctx_t *
        @param idx: the index of the database to switch to (C++: size_t)
