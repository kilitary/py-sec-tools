...
"""
has typeinfo? ( 'NSUP_TYPEINFO' ); used only for addresses, not for
'member_t'
"""
...
"""
the type information is definitive. (comes from the user or type
library) if not set see 'AFL_TYPE_GUESSED'
"""
...
def upd_abits(*args) -> "void":
    ...
    upd_abits(ea, clr_bits, set_bits)
        @param ea (C++: ea_t)
        @param clr_bits (C++: aflags_t)
        @param set_bits (C++: aflags_t)
    """
...
"""
a custom reference. see 'custom_refinfo_handler_t' . the id of the
custom refinfo is stored under the REFINFO_TYPE mask.
"""
...
def get_ida_notepad_text(*args) -> "ssize_t":
    r"""


    Get notead text.
    
    get_ida_notepad_text(text) -> ssize_t
        @param text (C++: qstring  *)
    """
...
def set_ida_notepad_text(*args) -> "void":
    ...
    set_ida_notepad_text(text, size=0)
        @param text (C++: const char *)
        @param size (C++: size_t)
    """
    return _ida_nalt.set_ida_notepad_text(*args)

def get_srcdbg_paths(*args) -> "ssize_t":
    r"""


    Get source debug paths.
    
    get_srcdbg_paths(paths) -> ssize_t
        @param paths (C++: qstring  *)
    """
...
def set_srcdbg_paths(*args) -> "void":
    ...
    set_srcdbg_paths(paths)
        @param paths (C++: const char *)
    """
    return _ida_nalt.set_srcdbg_paths(*args)

def get_srcdbg_undesired_paths(*args) -> "ssize_t":
    r"""


    Get user-closed source files.
    
    get_srcdbg_undesired_paths(paths) -> ssize_t
        @param paths (C++: qstring  *)
    """
...
def get_initial_ida_version(*args) -> "ushort":
    r"""


    Get version of ida which created the database (string format like
    "7.5")
    
    get_initial_ida_version(ver) -> ssize_t
        @param ver (C++: qstring  *)
    """
