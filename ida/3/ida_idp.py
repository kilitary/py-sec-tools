...
class IDP_Hooks(object):
    ...
    def ev_realcvt(self, *args) -> "int":
        ...
        ev_realcvt(self, m, e, swt) -> int
            @param m: ptr to processor-specific floating point value  (C++: void
                      *)
            @param e: IDA representation of a floating point value  (C++:
                      fpvalue_t *)
    ...
    def ev_is_control_flow_guard(self, *args) -> "int":
        ...
        ev_is_control_flow_guard(self, p_reg, insn) -> int
            @param p_reg: indirect register number, may be -1  (C++: int *)
            @param insn: call/jump instruction  (C++: const insn_t *)
    ...
    def ev_create_merge_handlers(self, *args) -> "int":
        ...
        ev_create_merge_handlers(self, md) -> int
            @param md: This event is generated immediately after opening idbs.
                       (C++: merge_data_t *)
            @return: must be 0
        """
    ...
    def ev_update_call_stack(self, *args) -> "int":
        ...
        ev_update_call_stack(self, stack, tid, getreg, regvalues) -> int
            @param stack: result  (C++: call_stack_t *)
            @param tid: thread id  (C++: int)
            @param getreg: function to get register values  (C++:
                           processor_t::regval_getter_t *)
            @param regvalues: register values array  (C++: const regval_t *)
            @retval: 1 - ok
    ...
    def ev_get_abi_info(self, *args) -> "int":
        ...
        ev_get_abi_info(self, abi_names, abi_opts, comp) -> int
            @param abi_names: - all possible ABis each in form
...
IBM's S390.
"""
PLFM_XTENSA          = 71       # Tensilica Xtensa
"""
Tensilica Xtensa.
"""
PLFM_RISCV           = 72       # RISC-V
"""
RISC-V.
"""
PLFM_RL78            = 73       # Renesas RL78
"""
Renesas RL78.
"""
...
class IDB_Hooks(object):
    ...
    def compiler_changed(self, *args) -> "void":
        ...
        compiler_changed(self, adjust_inf_fields)
            @param adjust_inf_fields: may change inf fields?  (C++: bool)
        """
    ...
    def renamed(self, *args) -> "void":
        ...
        renamed(self, ea, new_name, local_name, old_name)
            @param ea (C++: ea_t)
            @param new_name: can be nullptr  (C++: const char *)
            @param local_name (C++: bool)
            @param old_name: can be nullptr  (C++: const char *)
        """
    ...
    def bookmark_changed(self, *args) -> "void":
        ...
        bookmark_changed(self, index, pos, desc, operation)
            ...
            @param operation: 0-added, 1-updated, 2-deleted if desc==NULL, then
